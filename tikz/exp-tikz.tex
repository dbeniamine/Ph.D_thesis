...
\begin{tikzpicture}
    ...
    \node [Expebox, right=2em of main,rotate=90,anchor=north] (mach) {Experimental machine(s)};
    \end{pgfonlayer}
    ...
    \begin{pgfonlayer}{foreground}
        \node[fileR, right=8.5em of main] (raw) {Raw results};
    ...
    \node[fileR, right = 3em of csv] (res) {Human readable results};
