...
\begin{tikzpicture}[font=\small, every pic/.style={scale=.9}]
    ...
    \begin{pgfonlayer}{bbbg}
        \draw[line width=.5em] (cpu-0) -- (cpu-2);
        \draw[line width=.5em] (cpu-0) -- (cpu-1);
        \draw[line width=.2em]  (cpu-0) -- (cpu-3);
        \draw[line width=.5em] (cpu-1) -- (cpu-3);
        \draw[line width=.5em] (cpu-2) -- (cpu-3);
        \draw[line width=.2em]  (cpu-1) -- (cpu-2);
    \end{pgfonlayer}
