...
\begin{tikzpicture}[font=\small]
    ...
    \begin{pgfonlayer}{foreground}
        %% A
        \draw[PrimaryA,ColI]   (mA-0N) -- node [above] {\textbf{i}} (mA-NN);
        \draw[SecondaryA,ColK] (mA-0N) -- node [left]  {\textbf{k}} (mA-00);

        %% B
        \draw[PrimaryA,ColJ]   (mB-0N) -- node [left]  {\textbf{j}} (mB-00);
        \draw[SecondaryA,ColK] (mB-0N) -- node [above] {\textbf{k}} (mB-NN);

        %% C
        \draw[PrimaryA,ColI]   (mC-0N) -- node [above] {\textbf{i}} (mC-NN);
        \draw[SecondaryA,ColJ] (mC-0N) -- node [left]  {\textbf{j}} (mC-00);
    \end{pgfonlayer}
