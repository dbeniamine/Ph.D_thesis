...
In our example the computation on each value of the array is independent thus we can divide it in two and each thread will  work on one half as illustrated in \fig{false-sharing}.
