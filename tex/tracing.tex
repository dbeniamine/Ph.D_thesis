...
This chapter presents first the design and usage of \gls{Tabarnac} through a use case and discuss the obtained results, the overhead and limits of \gls{Tabarnac} in \sect{Tabarnac}.
Then we present the challenges raised by \gls{Moca}, its design and an experimental validation including an extensive comparison with existing memory trace collection tools in \sect{Moca}.
Finally we provide our conclusions on memory traces collection in \sect{tracing-cncl}.
