...
consider an experiment as a workflow (depicted in \fig{exp-pipeline}) that
...
\emph{experiment designer bias}\todo[author=david]{Il y a probablement une ref
ici}. One easy way to limit this bias is to write the parsing and analysis
...
\fig{exp-pipeline} we consider that an experimental plan includes not only the
