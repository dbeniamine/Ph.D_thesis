...
\begin{itemize}
    \item Experiment:
        \begin{itemize}
            ...
            \item Need to go from vague to precise / scientifique:
                \begin{itemize}
                    \item Metrics (What do we evaluate)
                    \item Benchmarks (In which condition do we measure it)
                    \item References (What are we comparing our results to)
                    \item Initial plots (How do we visualize it)
                \end{itemize}
        \end{itemize}
