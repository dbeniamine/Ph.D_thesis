...
\begin{table}[t]
    ...
    \begin{tabular}{lccccc}
        ...
        \midrule
        \multirow{2}{2cm}{Software} & kernel & \multicolumn{2}{c}{Distribution} & \multicolumn{2}{c}{Bios Configuration} \\
        \cmidrule(lr){2-6}
...
Yet,in the parallel version, the variability of the bandwidth in parallel increase significantly and we are not able to explain this behavior with our traces.
