...
\DB{Rewritte\\
    Positive => Our experiment could be improved by inspiring ourselves from place were they are expensives\ldots\\
    Define Similar
}
...
%% 
%% Many factors can impact perf, and not all can be captured
%% Yet if <list of factors> we can expect similar results, or one of the two experiment went wrong
%%% Limits: adaptive algorithms

Repeating an experiment in the sens of Feitelson in \gls{HPC} is nearly impossible.
