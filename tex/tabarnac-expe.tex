...
\lstinputlisting[caption={[Original IS code.]\IS code responsible for the distribution of memory accesses to the \texttt{key\_buff1} structure.}, label=lst:is, float=htb]{code/is.c}
