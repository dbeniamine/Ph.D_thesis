...
%We evaluate the following applications with \gls{Tabarnac} in this paper: %a \emph{matrix multiplication},
...
%The \emph{matrix multiplication} is a well-known algorithm that we use to verify the accuracy of \gls{Tabarnac}, as well as to discuss the performance improvements that can be achieved.
...
% In this section, we analyze several benchmarks using \gls{Tabarnac}, we discuss
...
%         \includegraphics[width=.45\linewidth] {tabarnac/mat_B_modulo}
%         \label{fig:matrix-B-naive}
%     }
%     \subfigure[Structure C (naive version).]{
%         \includegraphics[width=.45\linewidth] {tabarnac/mat_C_modulo}
%         \label{fig:matrix-C-naive}
%     }
%     \subfigure[Structure B (block version).]{
%         \includegraphics[width=.45\linewidth] {tabarnac/mat_B_bloc}
%         \label{fig:matrix-B-bloc}
%     }
%     \subfigure[Structure C (block version).]{
%         \includegraphics[width=.45\linewidth] {tabarnac/mat_C_bloc}
...
% %    \centering
% %    \subfigure[Structure B (block version).]{
% %        \includegraphics[height=.24\textheight] {tabarnac/mat_B_bloc}
% %        \label{fig:matrix-B-bloc}
% %    }
% %    \subfigure[Structure C (block version).]{
% %        \includegraphics[height=.24\textheight] {tabarnac/mat_C_bloc}
% %        \label{fig:matrix-C-bloc}
% %    }
...
% \begin{figure}[htb]
%     \centering
%     \includegraphics[width=.7\linewidth]{tabarnac/mat_time}
...
\begin{figure}[htb]
    ...
    %    \includegraphics[width=.45\linewidth] {tabarnac/ondes3d_vz0_dist_orig}
    %    \label{fig:ondes3d-behaviour-vz0-orig}
    %}
    %\subfigure[Access distribution after modifications.]{
    %    \includegraphics[width=.45\linewidth] {tabarnac/ondes3d_vz0_dist_modif}
...
\begin{figure}[htb]
    \centering
    \includegraphics[scale=.6]{tabarnac/ondes3d_exectime}
...
\begin{figure}[!tb]
    \centering
    \includegraphics[scale=.68]{tabarnac/is_exectime}
...
\begin{figure}[!htb]
    \centering
    \includegraphics[scale=.68]{tabarnac/tool-ovh.pdf}
...
%        \bottomrule
%    \end{tabular}
%    \caption{Slowdown factor of \gls{Tabarnac} instrumentation for the 10 NAS Parallel
...
\DB{Global overview, not enough, need temporal info, contribution published VPA'15}
